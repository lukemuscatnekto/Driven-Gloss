...
const services: ServiceItem[] = [
  {
    ...
    description:
      'Deep vacuum, dashboard wipe down, interior glass, plastics cleaned, and cabin refresh.',
    mobileDescription: 'Deep vacuum, dashboard, glass, plastics, and cabin refresh.',
    icon: InteriorIcon,
    accent: 'pink',
  },
  {
    ...
    description: 'Safe exterior wash, wheels cleaned, tyre dressing, and gloss-enhancing finish.',
    mobileDescription: 'Safe wash, wheels, tyre dressing, and gloss finish.',
    icon: ExteriorIcon,
    accent: 'cyan',
  },
  {
    ...
    description:
      'Interior and exterior detail combined for a cleaner, fresher, sharper-looking vehicle.',
    mobileDescription: 'Interior and exterior combined for a cleaner, sharper look.',
    icon: FullDetailIcon,
    accent: 'pink',
  },
  {
    ...
    description:
      'Spray wax, ceramic spray protection, clay towel treatment, and glass water repellent options.',
    mobileDescription: 'Spray wax, ceramic spray, clay towel, and glass repellent options.',
    icon: CeramicIcon,
    accent: 'cyan',
  },
]
